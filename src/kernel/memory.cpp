...
public:
	...
	virtual ~PhysicalMemory() { PS5SIM_NOT_IMPLEMENTED; }

	PS5SIM_CLASS_NO_COPY(PhysicalMemory);
...
public:
	...
	virtual ~FlexibleMemory() { PS5SIM_NOT_IMPLEMENTED; }

	PS5SIM_CLASS_NO_COPY(FlexibleMemory);
...
static void SelfTestSub64SharedPlaceholderAlias() {
	...
	if (consumed &&
		...
		*ptr      = 0x4b59545953553634ull; // "PS5SIMSU" magic
...
PS5SIM_SUBSYSTEM_UNEXPECTED_SHUTDOWN(Memory) {}

PS5SIM_SUBSYSTEM_DESTROY(Memory) {
...
int32_t PS5SIM_SYSV_ABI KernelMapNamedFlexibleMemory(void** addr_in_out, size_t len, int prot,
